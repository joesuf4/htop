...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [COLOR_PANEL_EDIT] = ColorPair(White,Blue),
      [COLOR_SCREENS_OTH_BORDER] = ColorPair(Blue,Blue),
      [COLOR_SCREENS_OTH_TEXT] = ColorPair(Black,Blue),
      [COLOR_SCREENS_CUR_BORDER] = ColorPair(Green,Green),
      [COLOR_SCREENS_CUR_TEXT] = ColorPair(Black,Green),
   },
   [COLORSCHEME_MONOCHROME] = {
      ...
      [COLOR_PANEL_EDIT] = A_BOLD,
      [COLOR_SCREENS_OTH_BORDER] = A_DIM,
      [COLOR_SCREENS_OTH_TEXT] = A_DIM,
      [COLOR_SCREENS_CUR_BORDER] = A_REVERSE,
      [COLOR_SCREENS_CUR_TEXT] = A_REVERSE,
   },
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [COLOR_PANEL_EDIT] = ColorPair(White,Blue),
      [COLOR_SCREENS_OTH_BORDER] = A_BOLD | ColorPair(Black,White),
      [COLOR_SCREENS_OTH_TEXT] = A_BOLD | ColorPair(Black,White),
      [COLOR_SCREENS_CUR_BORDER] = ColorPair(Green,Green),
      [COLOR_SCREENS_CUR_TEXT] = ColorPair(Black,Green),
   },
   [COLORSCHEME_LIGHTTERMINAL] = {
      ...
      [COLOR_PANEL_EDIT] = ColorPair(White,Blue),
      [COLOR_SCREENS_OTH_BORDER] = ColorPair(Blue,Black),
      [COLOR_SCREENS_OTH_TEXT] = ColorPair(Blue,Black),
      [COLOR_SCREENS_CUR_BORDER] = ColorPair(Green,Green),
      [COLOR_SCREENS_CUR_TEXT] = ColorPair(Black,Green),
   },
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [COLOR_PANEL_EDIT] = ColorPair(White,Blue),
      [COLOR_SCREENS_OTH_BORDER] = A_BOLD | ColorPair(Yellow,Blue),
      [COLOR_SCREENS_OTH_TEXT] = ColorPair(Cyan,Blue),
      [COLOR_SCREENS_CUR_BORDER] = ColorPair(Cyan,Cyan),
      [COLOR_SCREENS_CUR_TEXT] = ColorPair(Black,Cyan),
   },
   [COLORSCHEME_BLACKNIGHT] = {
      ...
      [COLOR_CPU_STEAL] = ColorPair(Cyan,Black),
      [COLOR_CPU_GUEST] = ColorPair(Cyan,Black),
      [COLOR_PANEL_EDIT] = ColorPair(White,Cyan),
      [COLOR_SCREENS_OTH_BORDER] = ColorPair(White,Black),
      [COLOR_SCREENS_OTH_TEXT] = ColorPair(Cyan,Black),
      [COLOR_SCREENS_CUR_BORDER] = A_BOLD | ColorPair(White,Black),
      [COLOR_SCREENS_CUR_TEXT] = A_BOLD | ColorPair(Green,Black),
   },
